public class Flight extends Thread {
    ...
    public void run() {
        ...
        // Departing
        departAirPort.getQueue().add(flightNum); // Add flight to queue
        ...
        departAirPort.makeFreeRunway(freeRunwayToDepart);
        ...
        // Landing
        landAirPort.getQueue().add(flightNum); // Add flight to queue
        ...
        landAirPort.makeFreeRunway(freeRunwayToLand);
        System.out.println("runway number " + (freeRunwayToDepart + 1) + " in " + departAirPort.getName() + " is clear");
    }
}
